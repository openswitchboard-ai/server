...
Which of the two a want or have is on is theirs to set on their approval page; leave it alone. Neither setting reaches the gate that matters: accepting an offer is still theirs, every single time.
